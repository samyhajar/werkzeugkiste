...
BEGIN
    ...
    -- Update existing RLS policies to be more permissive for admin operations
    -- This ensures admin users can perform DELETE operations

    -- Drop and recreate admin policies for lessons with more permissive DELETE
    ...
    -- Drop and recreate admin policies for courses with more permissive DELETE
    ...
    -- Update quiz attempts policies to handle both student_id and user_id columns
    ...
    RAISE NOTICE 'Fixed API issues: added missing fields and updated RLS policies';
