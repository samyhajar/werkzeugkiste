...
const partnerLogos = [
  { src: '/small_arbeitplus_NOe.jpg', alt: 'Arbeit Plus Niederösterreich', width: 200, height: 80 },
  { src: '/ak-noe-logo-e1644578170238.jpg', alt: 'AK Niederösterreich', width: 200, height: 80 },
  { src: '/small_fhstp.jpg', alt: 'FH St. Pölten', width: 200, height: 80 },
  { src: '/small_AK_EXTRA_LOGO_JPG.jpg', alt: 'AK Extra', width: 200, height: 80 },
]
...
export default function PartnerSection() {
  return (
    <section className="w-full flex flex-col items-center gap-12 py-16">
      ...
      {/* Federal logos under the funding text */}
