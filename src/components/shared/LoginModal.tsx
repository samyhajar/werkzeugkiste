                ...
                <TabsContent value="login" className="space-y-6 mt-0">
                  <form onSubmit={handleSignIn} className="space-y-6">
                    <p className="text-sm text-gray-600">
                      Mit <span aria-hidden="true">*</span> markierte Felder
                      sind Pflichtfelder.
                    </p>
                    <div className="space-y-2">
                      ...
                      <CustomInput
                        ...
                        aria-invalid={!!error}
                        aria-describedby={
                          error ? 'login-modal-error' : undefined
                        }
                      />
                    </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="mt-1 text-sm text-green-700">
                            <p>
                              Falls für{' '}
                              <span className="font-medium">{email}</span> eine
                              neue Bestätigung erforderlich ist, erhalten Sie
                              eine E-Mail. Aus Sicherheitsgründen können wir
                              hier nicht anzeigen, ob bereits ein Konto
                              existiert.
                            </p>
                            <p className="mt-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <CustomInput
                            ...
                            aria-invalid={!!error}
                            aria-describedby={
                              error ? 'signup-modal-error' : undefined
                            }
                          />
                        </div>
                        <div className="space-y-2">
