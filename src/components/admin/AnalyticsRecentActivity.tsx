...
export default function AnalyticsRecentActivity({ analytics }: AnalyticsRecentActivityProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <Card className="shadow-sm hover:shadow-lg transition-all duration-300 border-0 bg-gradient-to-br from-white to-[#486681]/5">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="text-lg text-[#486681]">This Week</CardTitle>
        ...
        <CardContent className="space-y-4">
          <div className="flex justify-between items-center p-3 rounded-lg bg-white shadow-sm">
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-[#486681] rounded-full"></div>
              <span className="text-sm font-medium">New Courses</span>
            </div>
            <Badge className="bg-[#486681]/10 text-[#486681] border-[#486681]/20">
